...
describe("converting safe investments with existing common stock", () => {
    test("Sanity check our baseline", () => {
        ...
        const fit = fitConversion(preMoneyValuation, common, safes, unusedOptions.amount, 0.0, seriesInvestments, { roundShares: true, roundPPSPlaces: 8 });
    ...
    test("matches our Google Sheet", () => {
        ...
        const fit = fitConversion(preMoneyValuation, common, safes, unusedOptions.amount, 0.1, seriesInvestments, { roundPPSPlaces: -1 });
    ...
    test("matches our known truth", () => {
        ...
        const fit = fitConversion(preMoneyValuation, common, safes, unusedOptions, 0.1, seriesInvestments, { roundDownShares: true, roundPPSPlaces: 5 });
        expect(fit.totalShares).toEqual(expectedTotalShares);
