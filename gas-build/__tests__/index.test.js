...
describe("converting safe investments with existing common stock", () => {
    test("matches our Google Sheet", () => {
        ...
        const fit = SAFE_CONVERSION(preMoneyValuation, common, safes, unusedOptions, 0.1, seriesInvestments, false, -1);
    ...
    test("Handles Errors", () => {
        ...
        const fit = SAFE_CONVERSION(preMoneyValuation, common, safes, unusedOptions, 0.1, seriesInvestment, false, -1);
